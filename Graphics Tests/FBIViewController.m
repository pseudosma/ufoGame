...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        FBIshadesView *shades = [[FBIshadesView alloc] initWithFrame:CGRectMake(0, 1, 18, 13)];
        [head addSubview:shades];
        
        FBIsuitView *suit = [[FBIsuitView alloc] initWithFrame:CGRectMake(-1, -1, 19, 25)];
        [body addSubview:suit];
        
        FBIsuitLegView *rPantLeg = [[FBIsuitLegView alloc] initWithFrame:CGRectMake(-2, -13, 10, 21)];
        rPantLeg.layer.anchorPoint = CGPointMake(.5,0);
        [rLeg addSubview:rPantLeg];
        
        FBIsuitLegView *lPantLeg = [[FBIsuitLegView alloc] initWithFrame:CGRectMake(-2, -13, 10, 21)];
        lPantLeg.layer.anchorPoint = CGPointMake(.5,0);
        [lLeg addSubview:lPantLeg];
        
        FBIsuitSleeveView *rSleeve = [[FBIsuitSleeveView alloc] initWithFrame:CGRectMake(-2, -12, 9, 21)];
        rSleeve.layer.anchorPoint = CGPointMake(.5, 0);
        [rArm insertSubview:rSleeve belowSubview:rHand];
        
        FBIsuitSleeveView *lSleeve = [[FBIsuitSleeveView alloc] initWithFrame:CGRectMake(-2, -12, 9, 21)];
