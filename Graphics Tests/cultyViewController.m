...
@interface cultyViewController ()

@end

@implementation cultyViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        cultyJumpsuitView *suit = [[cultyJumpsuitView alloc] initWithFrame:CGRectMake(-1, 0, 19, 25)];
        [body addSubview:suit];
        
        cultyJumpsuitLegView *rPantLeg = [[cultyJumpsuitLegView alloc] initWithFrame:CGRectMake(-2, -13, 10, 21)];
        rPantLeg.layer.anchorPoint = CGPointMake(.5,0);
        [rLeg addSubview:rPantLeg];
        
        cultyJumpsuitLegView *lPantLeg = [[cultyJumpsuitLegView alloc] initWithFrame:CGRectMake(-2, -13, 10, 21)];
        lPantLeg.layer.anchorPoint = CGPointMake(.5,0);
        [lLeg addSubview:lPantLeg];
        
        cultyJumpsuitSleeveView *rSleeve = [[cultyJumpsuitSleeveView alloc] initWithFrame:CGRectMake(-2, -12, 9, 21)];
        rSleeve.layer.anchorPoint = CGPointMake(.5, 0);
        [rArm insertSubview:rSleeve belowSubview:rHand];
        
        cultyJumpsuitSleeveView *lSleeve = [[cultyJumpsuitSleeveView alloc] initWithFrame:CGRectMake(-2, -12, 9, 21)];
