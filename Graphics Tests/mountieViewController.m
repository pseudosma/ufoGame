...
@implementation mountieViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        mountieUniformView *uniform = [[mountieUniformView alloc] initWithFrame:CGRectMake(-1, -1, 18, 28)];
        [body addSubview:uniform];
        
        mountieHatView *hat = [[mountieHatView alloc] initWithFrame:CGRectMake(-6,-8, 29, 18)];
        [head addSubview:hat];
        
        mountieUniformPantLegView *rPantLeg = [[mountieUniformPantLegView alloc] initWithFrame:CGRectMake(-2, -13, 10, 21)];
        rPantLeg.layer.anchorPoint = CGPointMake(.5,0);
        [rLeg addSubview:rPantLeg];
        
        mountieUniformPantLegView *lPantLeg = [[mountieUniformPantLegView alloc] initWithFrame:CGRectMake(-2, -13, 10, 21)];
        lPantLeg.transform = CGAffineTransformMakeScale(-1, 1);
        lPantLeg.layer.anchorPoint = CGPointMake(.5,0);
        [lLeg addSubview:lPantLeg];
        
        mountieUniformSleeveView *rSleeve = [[mountieUniformSleeveView alloc] initWithFrame:CGRectMake(-2, -12, 9, 21)];
        rSleeve.layer.anchorPoint = CGPointMake(.5, 0);
        [rArm insertSubview:rSleeve belowSubview:rHand];
        
        mountieUniformSleeveView *lSleeve = [[mountieUniformSleeveView alloc] initWithFrame:CGRectMake(-2, -12, 9, 21)];
